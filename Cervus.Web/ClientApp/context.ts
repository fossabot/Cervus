...
export module Context {
    type LazyInject = (serviceIdentifier: string | symbol | interfaces.Newable<any> |
        interfaces.Abstract<any>) => (proto: any, key: string) => void;
    type LazyInjectNamed = (serviceIdentifier: string | symbol | interfaces.Newable<any> |
        interfaces.Abstract<any>, named: string) => (proto: any, key: string) => void;
    type LazyInjectTagged = (serviceIdentifier: string | symbol | interfaces.Newable<any> |
        interfaces.Abstract<any>, key: string, value: any) => (proto: any, propertyName: string) => void;
    type LazyMultiInject = (serviceIdentifier: string | symbol | interfaces.Newable<any> |
        interfaces.Abstract<any>) => (proto: any, key: string) => void;
    ...
    let lazyInjectAux: LazyInject = id => (a, b) => { };
    let lazyInjectNamedAux: LazyInjectNamed = id => (a, b) => { };
    let lazyInjectTaggedAux: LazyInjectTagged = id => (a, b) => { };
    let lazyMultiInjectAux: LazyMultiInject = id => (a, b) => { };
